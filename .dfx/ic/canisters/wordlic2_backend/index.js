...
import { idlFactory } from './wordlic2_backend.did.js';
export { idlFactory } from './wordlic2_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_WORDLIC2_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./wordlic2_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the wordlic2_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./wordlic2_backend.did.js")._SERVICE>}
 */
export const wordlic2_backend = createActor(canisterId);
