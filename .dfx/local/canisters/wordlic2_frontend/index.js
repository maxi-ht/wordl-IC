...
import { idlFactory } from './wordlic2_frontend.did.js';
export { idlFactory } from './wordlic2_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_WORDLIC2_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./wordlic2_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the wordlic2_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./wordlic2_frontend.did.js")._SERVICE>}
 */
export const wordlic2_frontend = createActor(canisterId);
